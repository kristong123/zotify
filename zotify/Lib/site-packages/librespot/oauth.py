...
class OAuth:
    ...
    def ingest_token_response(self, result):
        ...
        # Spotify's refresh-grant response does not always include a new
        # refresh_token (per OAuth2 spec, it's not required to rotate on
        # every refresh) - keep the existing one instead of crashing.
